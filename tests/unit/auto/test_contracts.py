...
class TestCoreSchemaContract:
    ...
    def test_patch_rollback_required_for_high_level(self):
        ...
        p = Patch(
            ...
            proposal_id="prop_001",
            patch_level=2,
            patch_type="skill_parameter_patch",
    ...
    def test_champion_level_order(self):
        ...
        champ = Champion(
            id="c1", skill_id="pick_v1.5", task_id="pick_cube", level="sim", metrics={}
        )
