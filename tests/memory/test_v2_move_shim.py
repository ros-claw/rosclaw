...
def test_shim_deep_subpackages():
    from rosclaw.memory.regime.matcher import RegimeMatcher as R1
    from rosclaw.memory.runtime_retrieval.facade import MemoryRetrievalFacade as F1
    from rosclaw.memory.v2.regime.matcher import RegimeMatcher as R2
    from rosclaw.memory.v2.runtime_retrieval.facade import MemoryRetrievalFacade as F2

    assert R1 is R2 and F1 is F2
