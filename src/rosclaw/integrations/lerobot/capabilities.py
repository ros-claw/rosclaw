...
def get_lerobot_capabilities() -> list[IntegrationCapability]:
    ...
    return [
        ...
        IntegrationCapability(
            name="physical_telemetry_schema",
            kind="exporter",
            enabled=True,
            experimental=True,
            description="Physical telemetry schema (current, temperature, force/torque, contact, velocity, effort)",
        ),
        IntegrationCapability(
            name="physical_telemetry_export",
            kind="exporter",
            enabled=True,
            experimental=True,
            description="Physical telemetry export to LeRobotDataset features",
        ),
        IntegrationCapability(
            ...
            enabled=True,
            experimental=True,
            description="Per-frame source timestamps and clock domain metadata",
        ),
        IntegrationCapability(
            name="basic_timing_diagnostics",
            kind="exporter",
            enabled=True,
            experimental=True,
            description="Episode-level timing range, delta, and clock-domain statistics",
        ),
        IntegrationCapability(
