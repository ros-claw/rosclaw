...
def route_learners(signals: GrowthProblemSignals, data: DataProfile) -> LearnerRoute:
    """Choose complementary learners without treating every failure as PPO.

    The ordering is intentional: an incomplete safety model blocks learning;
    body/regime identification precedes policy adaptation; deterministic error
    uses ILC; and raw kinematic references cannot enter offline RL.
    """
