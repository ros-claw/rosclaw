...
class AgentEventType(StrEnum):
    ...
    # P1-B1（0824 总纲 §12）：V2 状态机/liveness/重启恢复事件。
    OPERATION_QUEUED = "operation.queued"
    OPERATION_ADMITTED = "operation.admitted"
    OPERATION_CANCELING = "operation.canceling"
    OPERATION_CANCELLED = "operation.cancelled"
    OPERATION_DEGRADED = "operation.degraded"
    OPERATION_RESUMED = "operation.resumed"
    OPERATION_REATTACHED = "operation.reattached"
    OPERATION_LOST = "operation.lost"
