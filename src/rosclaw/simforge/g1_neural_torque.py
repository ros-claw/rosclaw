...
class G1TorqueSafetyProjector:
    ...
    def _fallback(
        ...
        # torque guard.  Clip it into the conservative 0.85x parent envelope
        # only; candidate-only limits must not turn a fail-closed fallback
        # into a different controller.
