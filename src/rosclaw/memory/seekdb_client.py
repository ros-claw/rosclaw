...
SEEKDB_SCHEMAS: dict[str, Any] = {
    ...
    # Memory v4 (PR-MEM-6) — per-regime applicability envelopes
    "memory_applicability": {
        "columns": {
            "id": "TEXT PRIMARY KEY",
            "memory_id": "TEXT NOT NULL",
            "body_ids": "TEXT",
            "hardware_revisions": "TEXT",
            "firmware_versions": "TEXT",
            "calibration_hashes": "TEXT",
            "control_profile_hashes": "TEXT",
            "task_ids": "TEXT",
            "skill_ids": "TEXT",
            "gestures": "TEXT",
            "joints": "TEXT",
            ...
            "temperature_slope_min": "REAL",
            "temperature_slope_max": "REAL",
            "elapsed_sec_min": "REAL",
            "elapsed_sec_max": "REAL",
            "action_count_min": "INTEGER",
            "action_count_max": "INTEGER",
            "position_error_p95_min": "REAL",
            "position_error_p95_max": "REAL",
            "recent_failure_rate_min": "REAL",
            "recent_failure_rate_max": "REAL",
            "regime_labels": "TEXT",
            "envelope_type": "TEXT",
        ...
        "indices": ["memory_id", "envelope_type"],
    },
    # Memory v4 (PR-MEM-6) — regime snapshots + confirmed transitions
    "regime_history": {
        "columns": {
            "id": "TEXT PRIMARY KEY",
            "row_kind": "TEXT",
            ...
            "confidence": "REAL",
            "temperature_c": "REAL",
            "temperature_slope_c_per_min": "REAL",
            "from_label": "TEXT",
            "to_label": "TEXT",
        ...
        "indices": ["row_kind", "body_id", "regime_label"],
    },
    # Memory v4 (PR-HOW-3) — selective intervention decision ledger
    "selective_intervention_ledger": {
        "columns": {
            "id": "TEXT PRIMARY KEY",
            "action": "TEXT",
            "failure_signature": "TEXT",
            ...
            "reason_codes": "TEXT",
            "outcome": "TEXT",
            "wrong_body_apply": "INTEGER",
            "wrong_joint_apply": "INTEGER",
            "wrong_regime_apply": "INTEGER",
            "created_at": "REAL",
        },
        "indices": ["action", "memory_id", "outcome"],
    },
