        ...
        self._mcp_adapters = [
            McpCapabilityAdapter(
                McpServerConfig(
                    ...
                    output_schemas=dict(s.get("output_schemas", {}) or {}),
                    verifier_notes=dict(s.get("verifier_notes", {}) or {}),
    ...
    def _make_mcp_adapter(spec: dict, catalog) -> object:
        ...
        return McpCapabilityAdapter(
            McpServerConfig(
                ...
                output_schemas=dict(spec.get("output_schemas", {}) or {}),
                verifier_notes=dict(spec.get("verifier_notes", {}) or {}),
