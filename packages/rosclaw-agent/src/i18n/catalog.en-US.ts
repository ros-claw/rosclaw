...
export const CATALOG_EN: Record<CatalogKey, string> = {
	...
	"operator.bootstrap_hint": "[I] initialize and start  [Esc/N] cancel (actions stay blocked)",
	"operator.bootstrap_offer": "Operator not initialized — press I for one-key local setup (SIM developer), Esc to cancel",
