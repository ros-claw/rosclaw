# RealSense PointCloud Check

## What it does

Verify colored point cloud generation from RealSense.
...
```bash
rosclaw skill validate realsense_pointcloud_check
rosclaw skill install skills/realsense_pointcloud_check
```
