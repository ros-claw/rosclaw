...
| rosclawd Agent/物理执行边界 | **组件与系统已验证** | 独立进程 socket、有界协议、SO_PEERCRED、动作 peer 所有权、精确 Action Intent Permit、伪造/重放/参数替换阻止、队列、E-Stop 与关闭已通过系统测试；生产跨 UID、SROS2 和真机验收仍待完成。 |
...
队列、物理 Runtime、Driver、E-Stop Latch 和 Receipt。
...
| 阶段 | 重点 |
|---|---|
| **当前 / Alpha** | rosclawd 进程边界原型、可信 Action/Receipt 契约、Fixture/Provider/Driver 失败关闭、MuJoCo UR5e Reach 黄金闭环、分级 Doctor。 |
